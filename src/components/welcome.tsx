    ...
    public render(): React.ReactNode {
        return (
            <Content>
                ...
                scenarios. Our <a href="https://0x.org/portal">Portal</a> provides a user on-boarding flow to get you
                started with the 0x ecosystem. Documentation for 0x.js can be found on our{' '}
                <a href="https://0x.org/docs/0xjs">website</a>.
            </Content>
        );
    }
}
